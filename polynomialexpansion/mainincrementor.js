...
var mainUpdate = window.setInterval(function(){ // runs every 10ms, 100 times/sec
  ...
  document.getElementById("epsilonCount").innerHTML = "&epsilon;: " + prestige.epsilon
  document.getElementById("zetaCount").innerHTML = "&zeta;: " + prestige.zeta
  document.getElementById("etaCount").innerHTML = "&eta;: " + prestige.eta
  document.getElementById("thetaCount").innerHTML = "&theta;: " + prestige.theta
  document.getElementById("iotaCount").innerHTML = "&iota;: " + prestige.iota
  document.getElementById("kappaCount").innerHTML = "&kappa;: " + prestige.kappa
  document.getElementById("lambdaCount").innerHTML = "&lambda;: " + prestige.lambda
  document.getElementById("muCount").innerHTML = "&mu;: " + prestige.mu
  document.getElementById("nuCount").innerHTML = "&nu;: " + prestige.nu
  document.getElementById("xiCount").innerHTML = "&xi;: " + prestige.xi
  document.getElementById("omicronCount").innerHTML = "&omicron;: " + prestige.omicron
  document.getElementById("piCount").innerHTML = "&pi;: " + prestige.pi
  document.getElementById("rhoCount").innerHTML = "&rho;: " + prestige.rho
  document.getElementById("sigmaCount").innerHTML = "&sigma;: " + prestige.sigma
  document.getElementById("tauCount").innerHTML = "&tau;: " + prestige.tau
  document.getElementById("upsilonCount").innerHTML = "&upsilon;: " + prestige.upsilon
  document.getElementById("phiCount").innerHTML = "&phi;: " + prestige.phi
  document.getElementById("chiCount").innerHTML = "&chi;: " + prestige.chi
  document.getElementById("psiCount").innerHTML = "&psi;: " + prestige.psi
  document.getElementById("omegaCount").innerHTML = "&omega;: " + prestige.omega
