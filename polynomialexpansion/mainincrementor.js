...
var mainUpdate = window.setInterval(function(){ // runs every 10ms, 100 times/sec
  document.getElementById("jouleCount").innerHTML = numberformat.format(clickData.joules, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal}) + "J Generated"
  document.getElementById("JGenT1Count").innerHTML = "Cost: " + numberformat.format(clickData.JGenT1Cost, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal}) + ", You Have " + numberformat.format(clickData.JGenT1, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal}) + " Tier 1 Energy Generators"
  document.getElementById("JGenT2Count").innerHTML = "Cost: " + numberformat.format(clickData.JGenT2Cost, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal}) + ", You Have " + numberformat.format(clickData.JGenT2, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal}) + " Tier 2 Energy Generators"
  document.getElementById("JGenT3Count").innerHTML = "Cost: " + numberformat.format(clickData.JGenT3Cost, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal}) + ", You Have " + numberformat.format(clickData.JGenT3, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal}) + " Tier 3 Energy Generators"
  document.getElementById("JGenT4Count").innerHTML = "Cost: " + numberformat.format(clickData.JGenT4Cost, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal}) + ", You Have " + numberformat.format(clickData.JGenT4, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal}) + " Tier 4 Energy Generators"
  document.getElementById("JGenT5Count").innerHTML = "Cost: " + numberformat.format(clickData.JGenT5Cost, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal}) + ", You Have " + numberformat.format(clickData.JGenT5, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal}) + " Tier 5 Energy Generators"
  document.getElementById("JGenT6Count").innerHTML = "Cost: " + numberformat.format(clickData.JGenT6Cost, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal}) + ", You Have " + numberformat.format(clickData.JGenT6, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal}) + " Tier 6 Energy Generators"
  document.getElementById("JGenT7Count").innerHTML = "Cost: " + numberformat.format(clickData.JGenT7Cost, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal}) + ", You Have " + numberformat.format(clickData.JGenT7, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal}) + " Tier 7 Energy Generators"
  document.getElementById("JGenT8Count").innerHTML = "Cost: " + numberformat.format(clickData.JGenT8Cost, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal}) + ", You Have " + numberformat.format(clickData.JGenT8, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal}) + " Tier 8 Energy Generators"
  document.getElementById("JGenT9Count").innerHTML = "Cost: " + numberformat.format(clickData.JGenT9Cost, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal}) + ", You Have " + numberformat.format(clickData.JGenT9, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal}) + " Tier 1 Super Energy Generators"
  document.getElementById("JGenT10Count").innerHTML = "Cost: " + numberformat.format(clickData.JGenT10Cost, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal}) + ", You Have " + numberformat.format(clickData.JGenT10, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal}) + " Tier 2 Super Energy Generators"
  document.getElementById("JGenT11Count").innerHTML = "Cost: " + numberformat.format(clickData.JGenT11Cost, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal}) + ", You Have " + numberformat.format(clickData.JGenT11, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal}) + " Tier 3 Super Energy Generators"
  document.getElementById("JGenT12Count").innerHTML = "Cost: " + numberformat.format(clickData.JGenT12Cost, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal}) + ", You Have " + numberformat.format(clickData.JGenT12, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal}) + " Tier 4 Super Energy Generators"
  document.getElementById("JGenT13Count").innerHTML = "Cost: " + numberformat.format(clickData.JGenT13Cost, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal}) + ", You Have " + numberformat.format(clickData.JGenT13, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal}) + " Tier 5 Super Energy Generators"
  document.getElementById("JGenT14Count").innerHTML = "Cost: " + numberformat.format(clickData.JGenT14Cost, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal}) + ", You Have " + numberformat.format(clickData.JGenT14, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal}) + " Tier 6 Super Energy Generators"
  document.getElementById("JGenT15Count").innerHTML = "Cost: " + numberformat.format(clickData.JGenT15Cost, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal}) + ", You Have " + numberformat.format(clickData.JGenT15, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal}) + " Tier 7 Super Energy Generators"
  document.getElementById("JGenT16Count").innerHTML = "Cost: " + numberformat.format(clickData.JGenT16Cost, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal}) + ", You Have " + numberformat.format(clickData.JGenT16, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal}) + " Tier 8 Super Energy Generators"
  document.getElementById("alphaCount").innerHTML = "&alpha;: " + numberformat.format(prestige.alpha, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal})
  document.getElementById("betaCount").innerHTML = "&beta;: " + numberformat.format(prestige.beta, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal})
  document.getElementById("gammaCount").innerHTML = "&gamma;: " + numberformat.format(prestige.gamma, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal})
  document.getElementById("deltaCount").innerHTML = "&delta;: " + numberformat.format(prestige.delta, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal})
  document.getElementById("epsilonCount").innerHTML = "&epsilon;: " + numberformat.format(prestige.epsilon, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal})
  document.getElementById("zetaCount").innerHTML = "&zeta;: " + numberformat.format(prestige.zeta, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal})
  document.getElementById("etaCount").innerHTML = "&eta;: " + numberformat.format(prestige.eta, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal})
  document.getElementById("thetaCount").innerHTML = "&theta;: " + numberformat.format(prestige.theta, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal})
  document.getElementById("iotaCount").innerHTML = "&iota;: " + numberformat.format(prestige.iota, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal})
  document.getElementById("kappaCount").innerHTML = "&kappa;: " + numberformat.format(prestige.kappa, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal})
  document.getElementById("lambdaCount").innerHTML = "&lambda;: " + numberformat.format(prestige.lambda, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal})
  document.getElementById("muCount").innerHTML = "&mu;: " + numberformat.format(prestige.mu, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal})
  document.getElementById("nuCount").innerHTML = "&nu;: " + numberformat.format(prestige.nu, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal})
  document.getElementById("xiCount").innerHTML = "&xi;: " + numberformat.format(prestige.xi, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal})
  document.getElementById("omicronCount").innerHTML = "&omicron;: " + numberformat.format(prestige.omicron, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal})
  document.getElementById("piCount").innerHTML = "&pi;: " + numberformat.format(prestige.pi, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal})
  document.getElementById("rhoCount").innerHTML = "&rho;: " + numberformat.format(prestige.rho, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal})
  document.getElementById("sigmaCount").innerHTML = "&sigma;: " + numberformat.format(prestige.sigma, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal})
  document.getElementById("tauCount").innerHTML = "&tau;: " + numberformat.format(prestige.tau, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal})
  document.getElementById("upsilonCount").innerHTML = "&upsilon;: " + numberformat.format(prestige.upsilon, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal})
  document.getElementById("phiCount").innerHTML = "&phi;: " + numberformat.format(prestige.phi, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal})
  document.getElementById("chiCount").innerHTML = "&chi;: " + numberformat.format(prestige.chi, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal})
  document.getElementById("psiCount").innerHTML = "&psi;: " + numberformat.format(prestige.psi, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal})
  document.getElementById("omegaCount").innerHTML = "&omega;: " + numberformat.format(prestige.omega, {backend: 'break_eternity.js', format: 'standard', Decimal: Decimal})
