...
var mainUpdate = window.setInterval(function(){ // runs every 10ms, 100 times/sec
  ...
  document.getElementById("JGenT1Count").innerHTML = "Cost: " + numberformat.format(clickData.JGenT1Cost) + ", You Have " + numberformat.format(clickData.JGenT1) + " Tier 1 Energy Generators"
  document.getElementById("JGenT2Count").innerHTML = "Cost: " + numberformat.format(clickData.JGenT2Cost) + ", You Have " + numberformat.format(clickData.JGenT2) + " Tier 2 Energy Generators"
  document.getElementById("JGenT3Count").innerHTML = "Cost: " + numberformat.format(clickData.JGenT3Cost) + ", You Have " + numberformat.format(clickData.JGenT3) + " Tier 3 Energy Generators"
  document.getElementById("JGenT4Count").innerHTML = "Cost: " + numberformat.format(clickData.JGenT4Cost) + ", You Have " + numberformat.format(clickData.JGenT4) + " Tier 4 Energy Generators"
  document.getElementById("JGenT5Count").innerHTML = "Cost: " + numberformat.format(clickData.JGenT5Cost) + ", You Have " + numberformat.format(clickData.JGenT5) + " Tier 5 Energy Generators"
  document.getElementById("JGenT6Count").innerHTML = "Cost: " + numberformat.format(clickData.JGenT6Cost) + ", You Have " + numberformat.format(clickData.JGenT6) + " Tier 6 Energy Generators"
  document.getElementById("JGenT7Count").innerHTML = "Cost: " + numberformat.format(clickData.JGenT7Cost) + ", You Have " + numberformat.format(clickData.JGenT7) + " Tier 7 Energy Generators"
  document.getElementById("JGenT8Count").innerHTML = "Cost: " + numberformat.format(clickData.JGenT8Cost) + ", You Have " + numberformat.format(clickData.JGenT8) + " Tier 8 Energy Generators"
  document.getElementById("JGenT9Count").innerHTML = "Cost: " + numberformat.format(clickData.JGenT9Cost) + ", You Have " + numberformat.format(clickData.JGenT9) + " Tier 1 Super Energy Generators"
  document.getElementById("JGenT10Count").innerHTML = "Cost: " + numberformat.format(clickData.JGenT10Cost) + ", You Have " + numberformat.format(clickData.JGenT10) + " Tier 2 Super Energy Generators"
  document.getElementById("JGenT11Count").innerHTML = "Cost: " + numberformat.format(clickData.JGenT11Cost) + ", You Have " + numberformat.format(clickData.JGenT11) + " Tier 3 Super Energy Generators"
  document.getElementById("JGenT12Count").innerHTML = "Cost: " + numberformat.format(clickData.JGenT12Cost) + ", You Have " + numberformat.format(clickData.JGenT12) + " Tier 4 Super Energy Generators"
  document.getElementById("JGenT13Count").innerHTML = "Cost: " + numberformat.format(clickData.JGenT13Cost) + ", You Have " + numberformat.format(clickData.JGenT13) + " Tier 5 Super Energy Generators"
  document.getElementById("JGenT14Count").innerHTML = "Cost: " + numberformat.format(clickData.JGenT14Cost) + ", You Have " + numberformat.format(clickData.JGenT14) + " Tier 6 Super Energy Generators"
  document.getElementById("JGenT15Count").innerHTML = "Cost: " + numberformat.format(clickData.JGenT15Cost) + ", You Have " + numberformat.format(clickData.JGenT15) + " Tier 7 Super Energy Generators"
  document.getElementById("JGenT16Count").innerHTML = "Cost: " + numberformat.format(clickData.JGenT16Cost) + ", You Have " + numberformat.format(clickData.JGenT16) + " Tier 8 Super Energy Generators"
  document.getElementById("alphaCount").innerHTML = "&alpha;: " + numberformat.format(prestige.alpha)
  document.getElementById("betaCount").innerHTML = "&beta;: " + numberformat.format(prestige.beta)
  document.getElementById("gammaCount").innerHTML = "&gamma;: " + numberformat.format(prestige.gamma)
  document.getElementById("deltaCount").innerHTML = "&delta;: " + numberformat.format(prestige.delta)
  document.getElementById("epsilonCount").innerHTML = "&epsilon;: " + numberformat.format(prestige.epsilon)
  document.getElementById("zetaCount").innerHTML = "&zeta;: " + numberformat.format(prestige.zeta)
  document.getElementById("etaCount").innerHTML = "&eta;: " + numberformat.format(prestige.eta)
  document.getElementById("thetaCount").innerHTML = "&theta;: " + numberformat.format(prestige.theta)
  document.getElementById("iotaCount").innerHTML = "&iota;: " + numberformat.format(prestige.iota)
  document.getElementById("kappaCount").innerHTML = "&kappa;: " + numberformat.format(prestige.kappa)
  document.getElementById("lambdaCount").innerHTML = "&lambda;: " + numberformat.format(prestige.lambda)
  document.getElementById("muCount").innerHTML = "&mu;: " + numberformat.format(prestige.mu)
  document.getElementById("nuCount").innerHTML = "&nu;: " + numberformat.format(prestige.nu)
  document.getElementById("xiCount").innerHTML = "&xi;: " + numberformat.format(prestige.xi)
  document.getElementById("omicronCount").innerHTML = "&omicron;: " + numberformat.format(prestige.omicron)
  document.getElementById("piCount").innerHTML = "&pi;: " + numberformat.format(prestige.pi)
  document.getElementById("rhoCount").innerHTML = "&rho;: " + numberformat.format(prestige.rho)
  document.getElementById("sigmaCount").innerHTML = "&sigma;: " + numberformat.format(prestige.sigma)
  document.getElementById("tauCount").innerHTML = "&tau;: " + numberformat.format(prestige.tau)
  document.getElementById("upsilonCount").innerHTML = "&upsilon;: " + numberformat.format(prestige.upsilon)
  document.getElementById("phiCount").innerHTML = "&phi;: " + numberformat.format(prestige.phi)
  document.getElementById("chiCount").innerHTML = "&chi;: " + numberformat.format(prestige.chi)
  document.getElementById("psiCount").innerHTML = "&psi;: " + numberformat.format(prestige.psi)
  document.getElementById("omegaCount").innerHTML = "&omega;: " + numberformat.format(prestige.omega)
